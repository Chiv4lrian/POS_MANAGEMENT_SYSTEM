...
public class disable_products {
    ...
    public disable_products(String productId, String name, String category, double originalPrice, double price, int quantity, int stockLeft, LocalDate dateAssessed, LocalDate expiryDate) {
        ...
        if (connection != null) {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    productList.add(new disable_products(productId, name, category, originalPrice, price, quantity, stockLeft, dateAssessed, expiryDate));
                }
                resultSet.close();
                statement.close();
